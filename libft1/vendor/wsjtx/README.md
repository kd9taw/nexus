...
This directory is the **complete corresponding source** (GPL-3.0-or-later, §6) for
...
IV3NWV, and others), licensed under the **GNU GPL, version 3 or later**.
...
**GPL-3.0-or-later**, the same license as WSJT-X and as Nexus as a whole. See the
