...
> **FT1** is the native weak-signal text waveform of **Nexus** (its off-grid "Tempo" calling layer), by KD9TAW. Repository: [github.com/kd9taw/nexus](https://github.com/kd9taw/nexus) · Manual: see `docs/manual/` in the repo · License: GPL-3.0.
>
...
*Author: KD9TAW. License: GPL-3.0. Repository: [github.com/kd9taw/nexus](https://github.com/kd9taw/nexus) · Manual: `docs/manual/` (see `Tempo-Chat.md`, `Architecture-and-Protocol.md`, `Roadmap.md`).*
