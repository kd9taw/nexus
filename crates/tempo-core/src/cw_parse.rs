...
mod tests {
    ...
    fn report_received_recommends_73() {
        ...
        let sent = vec!["W1ABC DE KD9TAW UR 599 NAME PAT HW? W1ABC".to_string()];
        let a = analyze(
    ...
    fn closing_recommends_finish_and_log() {
        let sent = vec!["W1ABC DE KD9TAW UR 599 PAT".to_string()];
        let a = analyze(
    ...
    fn strict_shape_accepts_real_calls_rejects_noise() {
        ...
        for bad in ["5NN", "599", "5NN37", "TU", "73", "OP", "PAT1"] {
